...
def get_config():
    ...
    parser.add_argument("--transportation_net", type=str, default="siouxfalls", choices=["siouxfalls", "Anaheim", 'OW'])
    parser.add_argument("--ue_or_so", type=str, default="so", help="ue or so")
    parser.add_argument("--action_smoothing", type=float, default=0.0001, help="action smoothing threshold")
    parser.add_argument("--max_env_iter_num", type=int, default=50, help="max_env_iter_num")
    parser.add_argument("--OW_dynamic_demand", type=int, default=1, choices=[0, 1], help="0: fix, 1: dynamic OD demand")
    ...
    # optimizer parameters
    parser.add_argument("--lr", type=float, default=4e-5, help="learning rate (default: 5e-4)")
    parser.add_argument(
        "--critic_lr",
        type=float,
        default=4e-4,
    ...
    # actor exploration (std) scaling parameter
    parser.add_argument(
        "--std_scaling",
        type=float,
        default=1,
        help="by default 1. Scaling the std of the continuous action (gaussian distribution) to control the exploration.",
    )
