...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        self.opt_actions = np.zeros(
            (self.episode_length + 1, self.n_rollout_threads, num_agents, act_shape), dtype=np.float32)
        self.opt_actions[:, :, :, 0] = 1.
    ...
    def insert(self, share_obs, obs, rnn_states_actor, rnn_states_critic, actions, action_log_probs,
               value_preds, rewards, masks, opt_actions, bad_masks=None, active_masks=None, available_actions=None):
        """
        ...
        self.opt_actions[self.step + 1] = opt_actions.copy()
